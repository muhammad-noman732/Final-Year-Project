    ...
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-white/60 dark:border-white/[0.05] bg-white/40 dark:bg-slate-900/40 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-center justify-between px-4 py-3.5 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className={`flex items-center gap-1.5 text-[11px] font-medium ${connected ? "text-primary" : "text-[#64748B] dark:text-muted-foreground"}`}>
            {connected
      ...
      {newPaymentsCount > 0 && newAmountCollected > 0 && (
        <>
          <div className="mx-4 mb-3 rounded-lg border border-primary/10 bg-primary/[0.04] px-3 py-2">
            <p className="text-[11px] text-primary/70 mb-0.5">New this session</p>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <p className="flex-shrink-0 text-[12.5px] font-bold text-primary">
