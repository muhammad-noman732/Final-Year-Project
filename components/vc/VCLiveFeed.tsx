    ...
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-white/60 dark:border-white/[0.05] bg-white/40 dark:bg-slate-900/40 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-center justify-between px-4 py-3.5 flex-shrink-0">
        <div className="flex items-center gap-2">
          <div className="relative flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-500/10 dark:bg-emerald-500/20">
        ...
        <div className="flex items-center gap-2">
          {newPaymentsCount > 0 && (
            <span className="rounded-full bg-emerald-500/10 dark:bg-emerald-500/20 px-2 py-0.5 text-[11px] font-semibold text-emerald-600 dark:text-emerald-400">
              +{newPaymentsCount}
            </span>
          )}
          <div className={`flex items-center gap-1.5 text-[11px] font-medium ${connected ? "text-emerald-600 dark:text-emerald-400" : "text-[#64748B] dark:text-muted-foreground"}`}>
            {connected
      ...
      {newPaymentsCount > 0 && newAmountCollected > 0 && (
        <>
          <div className="mx-4 mb-3 rounded-lg border border-emerald-500/10 bg-emerald-500/[0.04] px-3 py-2">
            <p className="text-[11px] text-emerald-600/70 dark:text-emerald-400/70 mb-0.5">New this session</p>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <p className="flex-shrink-0 text-[12.5px] font-bold text-emerald-600 dark:text-emerald-400">
