...
export type RefreshTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "tokenHash" | "ipAddress" | "userAgent" | "deviceName" | "isRevoked" | "revokedAt" | "expiresAt" | "createdAt", ExtArgs["result"]["refreshToken"]>
