...
import { Eye, EyeOff, GraduationCap, Check, X, ShieldCheck } from "lucide-react";
...
export default function ChangePasswordPage() {
    ...
    const strengthLevel = strengthScore <= 1 ? "weak" : strengthScore === 2 ? "fair" : strengthScore === 3 ? "good" : "strong";
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex-1 flex gap-1">
                                            {[0, 1, 2, 3].map((i) => (
                                                <div
                                                    key={i}
                                                    className={`h-1.5 flex-1 rounded-full transition-all ${i < strengthScore ? strengthColors[strengthLevel] : "bg-navy-700"
                                                        }`}
                                                />
                                            ))}
                                        </div>
                                        <span
                                            className={`text-xs font-medium ${strengthLevel === "strong"
                                                    ? "text-emerald-400"
                                                    : strengthLevel === "good"
                                                        ? "text-sky-400"
                                                        : strengthLevel === "fair"
                                    ...
                                    <div className="grid grid-cols-2 gap-1.5">
                                        {[
                                            ...
                                            <div key={key} className="flex items-center gap-1.5">
                                                ...
                                                <span
                                                    className={`text-[11px] ${requirements[key as keyof typeof requirements]
                                                            ? "text-emerald-400"
