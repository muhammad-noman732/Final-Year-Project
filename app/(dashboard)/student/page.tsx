      ...
      <div className="max-w-5xl mx-auto space-y-5">
          ...
          <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {profile?.currentSemester && (
                <div className="flex items-center gap-1.5 rounded-lg border border-white/80 dark:border-white/[0.06] bg-white/60 dark:bg-white/[0.03] backdrop-blur-xl px-2.5 py-1.5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
              ...
              {paidCount > 0 && (
                <div className="flex items-center gap-1.5 rounded-lg border border-emerald-200/50 dark:border-emerald-500/15 bg-emerald-500/8 dark:bg-emerald-500/10 backdrop-blur-xl px-2.5 py-1.5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
        ...
        <Skeleton name="student-fee-card" loading={isLoading}>
          ...
          {current && (
            <motion.div
              ...
              className={[
                "rounded-2xl border overflow-hidden shadow-md backdrop-blur-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5",
                isOverdue
                  ? "border-rose-200/60 dark:border-rose-500/20 bg-white/70 dark:bg-rose-950/[0.08]"
                  : "border-white/80 dark:border-white/[0.1] bg-white/70 dark:bg-white/[0.03]",
              ].join(" ")}
            >
              <div className={[
              ...
              <div className="p-6 sm:p-8 space-y-7">
                ...
                <Link href="/student/payfee">
                  <Button className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-bold text-[13.5px] rounded-xl group transition-all duration-200 active:scale-[0.98] hover:scale-[1.01] hover:shadow-lg hover:shadow-primary/25 shadow-md shadow-primary/15">
        ...
        <Skeleton name="ledger-summary" loading={isLoading}>
          ...
          >
            ...
            { }
            <div className="rounded-xl border border-white/80 dark:border-white/[0.06] bg-white/60 dark:bg-white/[0.02] p-5 shadow-sm backdrop-blur-xl hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            { }
            <div className={[
              "rounded-xl border p-5 shadow-sm backdrop-blur-xl hover:shadow-md hover:-translate-y-0.5 transition-all duration-200",
              summary?.hasOverdue
                ? "border-rose-200/60 dark:border-rose-500/20 bg-rose-500/5"
                : isPaid
                  ? "border-emerald-200/50 dark:border-emerald-500/15 bg-emerald-500/8"
                  : "border-white/80 dark:border-white/[0.06] bg-white/60 dark:bg-white/[0.02]",
            ].join(" ")}>
              <p className="text-[9.5px] uppercase tracking-[0.2em] text-zinc-500 font-bold mb-2">
                Account status
              </p>
        ...
        <Skeleton name="ledger-transactions" loading={isLoading}>
          ...
          >
            ...
            <div className="rounded-2xl border border-white/80 dark:border-white/[0.06] bg-white/60 dark:bg-white/[0.02] divide-y divide-zinc-100/80 dark:divide-white/[0.04] overflow-hidden shadow-sm backdrop-blur-xl">
